	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://https://lxp521125.github.io/game/more",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://https://lxp521125.github.io/game/more";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://https://lxp521125.github.io/game/more";
y.url = function() {
	return "http://https://lxp521125.github.io/game/more?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://https://lxp521125.github.io/game/more/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("放松竞技小游戏—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("放松竞技小游戏", "Arial", 12);
