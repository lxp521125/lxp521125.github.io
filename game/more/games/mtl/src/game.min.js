	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://weixin.aitboy.cn/game/more",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://weixin.aitboy.cn/game/more";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://weixin.aitboy.cn/game/more";
y.url = function() {
	return "http://weixin.aitboy.cn/game/more?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://weixin.aitboy.cn/game/more/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
