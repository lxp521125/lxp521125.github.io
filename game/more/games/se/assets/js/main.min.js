...
var _config = {
    ...
    shareData = {
        imgUrl: "http://https://lxp521125.github.io/game/more/games/se/assets/img/find.logo.png",
        timeLineLink: "http://https://lxp521125.github.io/game/more/games/se/",
        tTitle: "看你有多色？",
        tContent: "找出所有色块中颜色不同的一块。分享朋友圈，找到身边的色魔，关注放松竞技小游戏:juhuiyouxi"
    };
! function() {
    var a = $("#box"),
        b = {
